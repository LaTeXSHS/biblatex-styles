...
\begin{frame}
	\frametitle{Alias}
	\begin{overprint}
		\code{Entre fichiers}{alias-fichier}
...
\begin{frame}
	...
	\begin{overprint}
		\code{Commandes Bib\LaTeX\ à redéfinir}{commandes}
...
\begin{frame}
	...
	\begin{overprint}
		\code{Imprimer fiel / liste / name}{imprimer-champ}
		\code{Tester la présence d'un champ}{iffieldundef}
		\code{Tester la valeur d'un champ}{iffielequals}
		...
		\only<+>{La liste est longue \ldot voir la documentation}
	\end{overprint}
\end{frame}
\end{document}